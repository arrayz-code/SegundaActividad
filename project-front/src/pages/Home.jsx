...
function Home() {
   return (
      <>
         <Header
            texto={'Ven y compra la herramienta de tu preferencia '}
            heigth='h-[25rem] sm:h-[30rem] md:h-[36rem]'
         />
      <main className='grid grid-cols-1 sm:grid-cols-3 gap-5 justify-center items-center text-base sm:text-lg md:text-xl'>{[
      {
      ...
      <section key={index} className={`p-10 flex flex-col justify-between items-center gap-5 font-medium ${index % 2 === 0 ? 'bg-amber-100' : ''}`}>
